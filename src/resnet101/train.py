...
# Hiperparâmetros
best_lr = 0.00048782687257166067
best_optimizer_name = "Adam"
best_batch_size = 128
best_dropout_rate = 0.14249018343673298
...
model.fc = nn.Sequential(
    nn.Linear(model.fc.in_features, best_n_units_fc1),
...
plt.savefig('./plots/resnet101.png')
plt.show()

os.makedirs('./models', exist_ok=True)

# Salvar o modelo treinado
model_save_path = './models/resnet101.pth'
